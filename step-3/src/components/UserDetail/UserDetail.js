...
export default function UserDetail() {
  ...
  useEffect(() => {
    fetchData(`https://reqres.in/api/users/${linkParams.userID}`, setUser, setFetchError);
  }, [linkParams.userID])
      ...
      <article className='details-card'>
        ...
        <div className='details-card__container'>
          <div className='details-card__image-container'>
            <img className='details-card__image' src={avatar} alt={`${first_name} ${last_name}`} />
          </div>
          <div className='details-card__info-container'>
            <h2 className='details-card__name'>{first_name} {last_name}</h2>
